...
export const WELCOME_PREFIX = `**Хто я?**

Вітаю! Я — ваш цифровий адміністратор. Я допомагаю швидко та зручно організувати ваш візит до нашого ${CLINIC_WELCOME_VENUE_UK}, де лікар-дерматокосметолог дбає про вашу красу за допомогою сучасних методів омолодження та ін'єкційних процедур.
